...
void init_sms()
{
  ...
  delay(400);
  Serial.println("AT+CMGS=\"+917675816446\"");   // use your 10 digit cell no. here
  delay(400);
}
...
{
    init_sms();
    send_data("Women and Children Safety system Alert");
    send_data("Location is:");
