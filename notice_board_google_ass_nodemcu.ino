...
#define AIO_USERNAME    "BNR403"
#define AIO_KEY         "aio_XHfN66KRBcEoErg13tVuvZi9ZL1s"
...
// Callback function for data that isg required for scrolling into the display
{
...
void setup()
{
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("BNR", "nagaraju");
  WiFiMulti.addAP("NAIDU", "raju12345");
  WiFiMulti.addAP("Net4u", "panipuri");
